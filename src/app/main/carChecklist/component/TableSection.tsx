...
import { formatDate } from '@/app/main/carChecklist/handler/handlerChecklist';
...
export default function TableSection({
  ...
  const columns = [
    ...
    { 
      ...
      render: (item: ChecklistItem) => formatDate(item.created_at)
    },
  ];
