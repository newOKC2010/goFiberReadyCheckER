...
import AddForm from '@/app/main/EmerList/component/add/AddForm';
import { handleAddSubmit } from '@/app/main/EmerList/component/add/utils/submitHandler';
...
export default function AddModal({ isOpen, onClose, onSuccess }: AddModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="เพิ่มทะเบียนรถ Emergency" showCloseButton={!loading}>
